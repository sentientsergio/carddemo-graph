...
compilerOption
   ...
   | SMARTBIN (LPARENCHAR (NAMES | NONAMES) RPARENCHAR)?
...
compilerDirectiveSource
   : (
   (COMPILER_DIRECTIVE_TAG (SOURCE_FORMAT_FREE_DIRECTIVE | SOURCE_FORMAT_FIXED_DIRECTIVE))
...
charDataKeyword
   ...
   | FASTSRT | FLAG | FLAGSTD | FULL | FSRT | FREE | FIXED
   | GDS | GRAPHIC
   | HEX | HGPR | HOOK
